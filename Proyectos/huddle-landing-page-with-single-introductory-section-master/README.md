...
Este proyecto es una solución al reto de [Frontend Mentor](https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0) para construir una **Página de inicio de Huddle con una sola sección introductoria**.  
